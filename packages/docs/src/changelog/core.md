...
## 1.5.1 <Badge type="tip" text="2025-12-23" />

### 修复

- 修复依赖引入的问题

## 1.5.0 <Badge type="tip" text="2025-12-23" />
...
## 1.4.0 <Badge type="tip" text="2025-11-20" />
...
## 1.3.4 <Badge type="tip" text="2025-11-08" />
...
## 1.3.3 <Badge type="tip" text="2025-11-08" />

### 优化

- 优化遮罩层的渲染效果。

## 1.3.2 <Badge type="tip" text="2025-11-07" />

### 优化

- 优化弹出层在亮色主题下，遮罩层的渲染效果。

## 1.3.1 <Badge type="tip" text="2025-11-07" />

### 修复

- 修复渲染参数 `viewAnimation` 偶现无法正确触发动画的问题。

## 1.3.0 <Badge type="tip" text="2025-11-05" />
...
## 1.2.1 <Badge type="tip" text="2025-10-31" />
...
## 1.2.0 <Badge type="tip" text="2025-10-29" />
...
## 1.1.5 <Badge type="tip" text="2025-10-28" />

### 修复

- 修复类型导出问题，确保在使用时能够正确获取到类型定义。

## 1.1.4 <Badge type="tip" text="2025-10-28" />

### 修复

- 修复类型导出问题，确保在使用时能够正确获取到类型定义。

## 1.1.3 <Badge type="tip" text="2025-10-28" />

### 修复

- 修复类型导出问题，确保在使用时能够正确获取到类型定义。

## 1.1.2 <Badge type="tip" text="2025-10-28" />

### 修复

- 修复核心的控制器默认挂载 `Vue` 实例的类型声明问题，提供完善的类型定义。

## 1.1.1 <Badge type="tip" text="2025-10-28" />

### 修复

- 修复类型导出问题，确保在使用时能够正确获取到类型定义。

## 1.1.0 <Badge type="tip" text="2025-10-27" />
...
## 1.0.0 <Badge type="tip" text="2025-10-27" />
