...
- `Toast 轻量提示` 优化 **移动端** 展示效果。
- `Message 消息` 优化 **移动端** 展示效果。
...
- `Album 媒体相册` 新增 `disableLoop` 参数，用于禁用循环切换，默认开启循环切换。
- `Album 媒体相册` 新增 `disableRotate` 参数，用于禁用旋转，默认开启旋转功能。

### 优化

- `Album 媒体相册` 优化 `sources` 参数，支持传入一个对象，用于手动设置媒体资源的类型。

### 适配

- 适配 <DVersion version="1.7.0-beta.1" /> 版本。
...
- 优化对核心版本的要求，使用宽松版本号匹配，完全匹配 <DVersion version="1.6.x" /> 版本。
...
- 适配 <DVersion version="1.3.0" /> 版本。

## 1.2.1 <Badge text="2025-10-31" />

### 适配

- 适配 <DVersion version="1.2.1" /> 版本。
...
- 适配 <DVersion version="1.2.0" /> 版本。

## 1.1.5 <Badge text="2025-10-28" />

### 适配

- 适配 <DVersion version="1.1.5" /> 版本。

## 1.1.4 <Badge text="2025-10-28" />

### 适配

- 适配 <DVersion version="1.1.4" /> 版本。

## 1.1.3 <Badge text="2025-10-28" />

### 适配

- 适配 <DVersion version="1.1.3" /> 版本。

## 1.1.2 <Badge text="2025-10-28" />

### 适配

- 适配 <DVersion version="1.1.2" /> 版本。

## 1.1.1 <Badge text="2025-10-28" />

### 适配

- 适配 <DVersion version="1.1.1" /> 版本。

## 1.1.0 <Badge text="2025-10-27" />

### 适配

- 适配 <DVersion version="1.1.0" /> 版本。
